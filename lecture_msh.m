%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Programme de Mme. Fliss
%
% lecture_msh.m :
% routine de lecture de fichiers de maillages triangulaires 2D au format .msh 
% 
% SYNOPSIS [Nbpt,Nbtri,Coorneu,Refneu,Numtri,Reftri,Nbaretes,Numaretes,Refaretes]=lecture_msh(nomfile)
%          
...
%        - Numaretes(Nbaretes,2) : numero des 2 Noeuds de chaque Arete de la frontière 
%		 - Refaretes(Nbaretes,1) : Reference de chaque arête de la
%                   frontière
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%2020
